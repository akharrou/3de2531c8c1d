  ...
  return (
    <section id="about" className="py-24 bg-secondary relative overflow-hidden">
      <div className="container mx-auto px-6 lg:px-8 relative z-[1]">
        ...
        <div className="grid lg:grid-cols-2 gap-x-16 gap-y-12 items-start mb-24">
          {/* Dr. Sarah Chen Column */}
          <div className="flex flex-col space-y-6">
            <div className="animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
              <Image
                ...
                width={500}
                height={600}
                className="rounded-2xl shadow-xl object-cover w-full h-auto md:max-h-[500px]"
